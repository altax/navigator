  ...
  if (isVector) {
    ...
    return {
      ...
      sources: {
        ...
        "pois-db": {
          type: "vector" as const,
          tiles: [`${window.location.origin}/api/tiles/pois_layer/{z}/{x}/{y}`],
          minzoom: 10,
          maxzoom: 22,
        },
        "selected-building": {
      ...
      layers: [
        ...
        },
        {
          ...
          minzoom: 9,
          maxzoom: 15,
          filter: ["all", ["has", "name"], ["in", ["get", "place"], ["literal", ["suburb", "neighbourhood", "quarter", "village", "town"]]]],
          layout: {
            "text-field": ["coalesce", ["get", "name:ru"], ["get", "name"]] as never,
            "text-font": ["Noto Sans Bold"],
            "text-size": [
              "interpolate", ["linear"], ["zoom"],
              9, ["match", ["get", "place"], "town", 12, "village", 10, "suburb", 11, 9],
              14, ["match", ["get", "place"], "town", 18, "village", 14, "suburb", 16, 13],
            ],
        ...
        },
        {
          ...
          layout: {
            ...
            "text-font": ["Noto Sans Bold"],
            "text-size": ["interpolate", ["linear"], ["zoom"], 16, 9, 17, 13, 19, 18],
            "text-padding": 12,
          ...
          paint: {
            "text-color": "#ffd166",
            "text-halo-color": "#0e1116",
            "text-halo-width": ["interpolate", ["linear"], ["zoom"], 16, 1.5, 17, 2.5, 19, 3.5],
            "text-halo-blur": 0.3,
            "text-opacity": ["interpolate", ["linear"], ["zoom"], 16, 0.7, 17, 1],
          },
        },
        {
          id: "poi-labels",
          ...
          layout: {
            ...
            "text-field": [
              ...
              "\n",
              ["coalesce",
                ["get", "amenity"], ["get", "shop"], ["get", "office"],
                ["get", "tourism"], ["get", "leisure"], ["get", "healthcare"], ["get", "craft"],
                "",
              ],
            ] as never,
            "text-font": ["Noto Sans Regular"],
          ...
          paint: {
            "text-color": [
              "match", ["get", "amenity"],
              ["hospital", "clinic", "pharmacy", "doctors"], "#f87171",
              ["school", "kindergarten", "university", "college"], "#c4b5fd",
              ["restaurant", "cafe", "bar", "fast_food", "food_court"], "#fb923c",
              ["bank", "atm"], "#34d399",
              "#cbd5e1",
            ],
            "text-halo-color": "#050810",
            "text-halo-width": 1.8,
            "text-opacity": ["interpolate", ["linear"], ["zoom"], 15, 0.65, 16, 1],
          },
        },
        {
          id: "poi-nodes",
          ...
          paint: {
            ...
            "text-halo-color": "#050810",
            "text-halo-width": 1.8,
            "text-opacity": ["interpolate", ["linear"], ["zoom"], 14, 0.7, 15, 1],
          },
        },
        {
