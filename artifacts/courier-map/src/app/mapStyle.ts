      ...
      layers: [
        ...
        },
        {
          ...
          layout: {
            ...
            "text-font": ["Noto Sans Bold"],
            "text-size": ["interpolate", ["linear"], ["zoom"], 13, 8, 15, 11, 17, 15, 19, 20],
            "text-padding": 4,
          ...
          paint: {
            "text-color": "#ffd166",
            "text-halo-color": "#0e1116",
            "text-halo-width": ["interpolate", ["linear"], ["zoom"], 13, 1.5, 15, 2, 17, 3],
            "text-halo-blur": 0.4,
            "text-opacity": ["interpolate", ["linear"], ["zoom"], 13, 0.6, 14, 0.8, 15, 1],
          },
        },
        {
          id: "poi-labels",
          ...
          paint: {
            "text-color": [
              ...
              ["school", "kindergarten", "university", "college"], "#a78bfa",
              ["restaurant", "cafe", "bar", "fast_food", "food_court"], "#fb923c",
              ["bank", "atm"], "#34d399",
              "#94a3b8",
            ],
            "text-halo-color": "#060a10",
            "text-halo-width": 1.4,
            "text-opacity": ["interpolate", ["linear"], ["zoom"], 15, 0.5, 16, 0.85, 17, 1],
          },
        },
        {
